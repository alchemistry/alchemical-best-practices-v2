...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{The messy implementation details of alchemical transformations}
...
\begin{figure}
    ...
    Soft-core potentials provide one of the most efficient families of intermediate pathways, with a $\lambda$ dependence. In (\textbf{C}) the potential energy surface is coloured according to $\lambda$ with blue being $\lambda=0$ and $\lambda=1$ orange. In (\textbf{D}) the potential is coloured according to the potential energy. Note how as $\lambda$ approaches 0, the energy smoothly approaches zero at all $r$, a necessary requirement for efficient and stable calculations.  }
